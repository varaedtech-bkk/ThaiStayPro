...
export default function TaskReminders() {
  return (
    <DashboardLayout title="Task Reminders">
        ...
        <div className="flex">
          ...
          <div className="ml-3 flex-1 md:flex md:justify-between">
            <p className="text-sm text-purple-700">
              Stay on top of your tasks and deadlines. Create reminders for meetings, assignments, and more.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4">
        <RemindersList reminderType="task" />
      </div>
    </DashboardLayout>
  );
}
